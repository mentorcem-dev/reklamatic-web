  ...
  return (
    <div className="site-shell">
      ...
      <header className="site-header">
        ...
        <nav aria-label="Main navigation"><a href="#sponsorships">Sponsorships</a><a href="#proof">Proof</a><a href="#system">Our system</a><a href="#packages">Packages</a></nav>
      ...
      <main>
        <section className="hero section" id="top">
          <div className="hero-copy reveal">
            <p className="eyebrow">SPONSORED SHORT VIDEOS + OUR OWN DISTRIBUTION NETWORK</p>
            <h1>Put your product inside content people already want to watch.</h1>
            <p className="hero-lead">We create short product stories and publish them through 26 Instagram, Facebook, TikTok and YouTube channels that we operate. Your product is not left as a video file—it is placed in front of real audiences.</p>
            <div className="hero-actions"><a className="button primary" href="#packages">See campaign packages</a><a className="button secondary" href="#proof">See real proof</a></div>
        ...
        <section className="proof section" id="proof">
          ...
          <div className="proof-gallery">
            ...
            <figure className="reveal"><Image src="/proof/facebook-28-day.jpg" width={1512} height={805} alt="Facebook analytics showing 2.3 million views in a 28-day period" /><figcaption><strong>2.3M views on one Facebook page</strong><span>A real 28-day analytics screen—not a projected result.</span></figcaption></figure>
            <figure className="proof-wide reveal"><Image src="/proof/tiktok-performance.jpg" width={1504} height={801} alt="TikTok channel grid with multiple video view counts" /><figcaption><strong>Performance beyond one channel</strong><span>TikTok content with visible results including 252.2K, 184.7K, 124.2K and 42.6K views.</span></figcaption></figure>
          </div>
