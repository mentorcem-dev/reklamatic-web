...
export const metadata = { title: "Privacy Policy", description: "How Reklamatic.ai handles website inquiries and service data.", alternates: { canonical: "https://reklamatic.ai/privacy", languages: { en: "https://reklamatic.ai/privacy", tr: "https://reklamatic.ai/tr/privacy" } } };

export default function PrivacyPage() {
  return (
    <LegalPage eyebrow="REKLAMATIC.AI" title="Privacy Policy" updated="July 27, 2026" otherHref="/terms" otherLabel="Terms" languageHref="/tr/privacy" languageLabel="Türkçe">
      <h2>Who is responsible</h2>
      <p>Reklamatic.ai, operated by Cem Gülçağ in Türkiye, is responsible for the personal data described here. Privacy requests can be sent to <a href="mailto:info@reklamatic.ai">info@reklamatic.ai</a>.</p>
