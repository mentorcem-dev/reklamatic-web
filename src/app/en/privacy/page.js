...
export default function PrivacyPage() {
  return (
    <LegalPage eyebrow="REKLAMATIC.AI" title="Privacy Policy" updated="July 27, 2026" homeHref="/en" otherHref="/en/terms" otherLabel="Terms" languageHref="/privacy" languageLabel="Türkçe">
