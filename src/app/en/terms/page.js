...
export const metadata = { title: "Terms of Service", description: "Terms for Reklamatic.ai clipping services and publishing tools.", alternates: { canonical: "https://reklamatic.ai/en/terms", languages: { tr: "https://reklamatic.ai/terms", en: "https://reklamatic.ai/en/terms", "x-default": "https://reklamatic.ai/terms" } } };

export default function TermsPage() {
  return (
    <LegalPage eyebrow="REKLAMATIC.AI" title="Terms of Service" updated="July 27, 2026" homeHref="/en" otherHref="/en/privacy" otherLabel="Privacy" languageHref="/terms" languageLabel="Türkçe">
